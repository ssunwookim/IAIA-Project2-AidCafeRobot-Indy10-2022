...
class CameraNode2:
    ...
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture(4)          # 카메라 연결을 위한 VideoCapture 객체 생성

        # 카메라 해상도를 640x480으로 설정
        self.cap.set(cv2.CAP_PROP_FRAME_WIDTH, 640)   # 프레임 너비 설정
        self.cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 480)  # 프레임 높이 설정
